...
const OrderAllCancel = () => {
  ...
  const currentOrders = canceledOrders.slice(indexOfFirstOrder, indexOfLastOrder); // Lấy danh sách đơn hàng hiện tại
  const totalPages = Math.ceil(canceledOrders.length / ordersPerPage); // Tổng số trang
